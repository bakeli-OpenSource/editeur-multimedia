...
// Profil USER
const inputElement = document.getElementById("updateProfil");
const imgElement = document.getElementById("userProfil");

// Charger l'image enregistrée dans localStorage au démarrage
document.addEventListener("DOMContentLoaded", function () {
...
inputElement.addEventListener("change", function (event) {
  ...
  reader.onload = function (e) {
    ...
    localStorage.setItem("profileImage", imageData); // Sauvegarder l'image
  };
